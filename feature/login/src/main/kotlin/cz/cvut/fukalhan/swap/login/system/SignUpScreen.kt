...
import cz.cvut.fukalhan.swap.login.presentation.SignUpState
...
fun SignUpScreen(viewModel: SignUpViewModel) {
    ...
    ShowSignUpStateMessage(context, signUpState)
...
@Composable
fun ShowSignUpStateMessage(context: Context, signUpState: SignUpState) {
    if (signUpState.showMessage) {
        Toast.makeText(context, stringResource(signUpState.messageResId), Toast.LENGTH_SHORT).show()
    }
}
